			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('sendingBlock'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Views_MainView$view = function (model) {
	return A2(
		...
		A2(_elm_lang$core$List$map, _user$project$Views_ChatBox$chatBox, model));
};
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: A2(_elm_lang$core$List$map, _user$project$Main$createInitialUser, _user$project$Main$users),
